...
for j=1:3
    ...
    amplitude_data = {
        ...
        'OD: ' [saccade_count(1), saccade_count(3), saccade_count(5)];
        'OS: ' [saccade_count(2), saccade_count(4), saccade_count(6)];
        ...
        'OD: ' sprintf('%.3f, ',(std(all_raw_data(:,2:length(all_raw_data(1,:)))))/sqrt(length(time)));
        'OS: ' strcat(',,,,,,', sprintf('%d, ',saccade_count))};
